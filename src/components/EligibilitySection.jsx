...
const EligibilitySection = () => {
    ...
    return (
        <div className="px-4 py-8 md:px-16 lg:px-24 ">
            ...
            <div className="lg:max-w-[90%] mx-auto p-12 rounded-[50px] shadow-md text-white bg-primary mt-6">
                <p className="text-center font-nunito">
                    Course Timing <span className=" lg:text-2xl">Join Our Pastry & Bakery Program!</span>
                </p>
                <p className="text-center mt-4 font-nunito">
                 <span className="font-semibold lg:text-2xl ">Embark on your Pastry & Bakery journey with our comprehensive Pastry & Bakery program for Rs 2,00,000 (inclusive of GST).</span>
                </p>

                {/* Study Materials Section */}
                <div className="mt-6 text-center font-nunito">
                    <p className="text-lg">
                        <span className="font-semibold text-2xl">This fee covers all necessary ingredients, a complete toolkit, extensive study materials, and a professional uniform (chef coat, apron, and cap).</span> 
                    </p>
